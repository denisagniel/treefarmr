...
root-first. We show that topology is recovered with probability tending to one
on a refining grid, and that every refined threshold is simultaneously
superconsistent, at rate $O_p(n^{-1})$. The algorithm is implemented, and its
...
\item \textbf{Two contributions.} (i) the two-stage algorithm --
  ...
  \citep{chan1993}, despite topology itself being estimated.
