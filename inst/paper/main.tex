...
\]
and depth bound \(2\bar D\) (the leaf budget is truncated at the grid's own
...
and depth \(2\bar D\) are required.
...
two conditions require \(r_n^{p+1}=o(n)\).  Under the inflated Stage-A
budgets \(\bar L_A=\min\{2\bar L-1,N_{r_n}\}\) and \(2\bar D\),
\[
  \PP\left(
    \begin{array}{c}
